...
function Vision() {
    return (
        <div className='flex-col'>
            <div className='bg-black text-justify text-white desktop:text-5xl desktop:m-5 desktop:p-20 lg:text-2xl lg:m-10 lg:p-10 phone:text-md gilroy-semibold'>
            ...
            <div className="bg-black desktop:text-5xl desktop:m-10 desktop:p-20 lg:text-2xl lg:m-10 lg:p-10 bg-gradient-to-br from-violet-800 via-pink-600 to-yellow-400 rounded-xl shadow">
