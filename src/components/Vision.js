...
function Vision() {
    return (
        <div>
            <div className='align-right text-white mt-20 ml-20 mr-20 text-l'>
            ...
            <div className="mt-5 text-l mr-20 ml-20 pr-6 pl-6 pt-10 pb-10 bg-gradient-to-br from-violet-800 via-pink-500  to-yellow-200 border border-gray-200 rounded-xl shadow">
