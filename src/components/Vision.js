...
function Vision() {
    return (
        <div>
            <div className='bg-black text-justify text-white mt-40 ml-10 mr-10 laptop:text-xl phone:text-md gilroy-semibold'>
            ...
            <div className="bg-black text-l ml-10 mr-10 p-8 bg-gradient-to-br from-violet-800 via-pink-500  to-yellow-200 border border-gray-200 rounded-xl shadow">
