...
function Vision() {
    return (
        <div className='flex-col'>
            ...
            <div className="bg-black tablet:mx-20 desktop:text-5xl desktop:m-10 desktop:p-20 tablet:text-2xl tablet:p-10 phone:m-10 phone:p-5 bg-gradient-to-br from-violet-800 via-pink-600 to-yellow-400 rounded-xl shadow">
                ...
                <a href="#" className="flex gilroy-bold text-white hover:underline">
                    Sound Good? Let’s Talk<img className='tablet:h-8' src={arrow}></img>
                </a>
            </div>
        </div>
    )
