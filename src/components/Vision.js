...
function Vision() {
    return (
        <div>
            <div className='align-right text-white mt-20 ml-20 mr-20 text-xl'>
            ...
            <div className="mt-5 text-xl mr-20 ml-20 pr-6 pl-6 pt-10 pb-10 bg-gradient-to-br from-violet-800 via-pink-500  to-yellow-200 border border-gray-200 rounded-xl shadow">
                <p className="mb-3 font-sans text-white">We want to hear about your brand and business challenges, even if you're unsure of your next steps. We promise that there will be no sales pitch and no strings attached.</p>
                <a href="#" className="flex text-bold font-bold text-white hover:underline">
